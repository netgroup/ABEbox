...
if __name__ == '__main__':
    ...
    ciphertext_file = 'test_file.cpabe'
    policy = '(sysadmin and (hire_date < 946702800 or security_team)) or (business_staff and 2 of (exec_level >= 5#4, '\
             'audit_group, strat_team))'
    ...
    print('\n\nDECRYPTED FILE:\n')
    with open(decrypted_file, 'r') as fin:
        for line in fin:
            print(line)
