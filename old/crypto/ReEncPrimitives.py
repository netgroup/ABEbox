...
def re_encrypt(ciphertext_infile=None, re_enc_length=None, new_pk_file=None, policy=None, debug=0):
    ...
    from old.crypto.Const import RE_ENC_LENGTH
    import logging
    import os.path
    ...
    from old.crypto.Const import SYM_KEY_DEFAULT_SIZE, SEED_LENGTH
    import struct
...
def apply_punctured_enc(ciphertext_infile=None, ciphertext_offset=None, ciphertext_length=None, re_enc_length=None,
    ...
    from old.crypto.Const import RE_ENC_MIN_LENGTH, RE_ENC_LENGTH
    from old.FunctionUtils import clamp
...
def re_enc_bytes(ciphertext_infile=None, ciphertext_offset=None, ciphertext_length=None, re_enc_length=None, debug=0):
    ...
    from old.crypto.Const import IV_DEFAULT_SIZE, SEED_LENGTH
    from old.crypto.SymEncPrimitives import sym_key_gen, generate_iv
    ...
    if re_enc_length < ciphertext_length:  # Apply punctured encryption
        ...
        from old.FunctionUtils import generate_random_string
...
def get_re_enc_params(file=None, debug=0):
    ...
    from old.crypto.Const import H, IV_DEFAULT_SIZE
    import struct
...
def decrypt_seed_key(enc_seed_key=None, pk_file=None, sk_file=None, debug=0):
    ...
    from old.crypto.Const import H, SYM_KEY_DEFAULT_SIZE, SEED_LENGTH
    import struct
